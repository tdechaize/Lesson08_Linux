/*
=====================================================================
OpenGL Lesson 08 :  Creating Another OpenGL Window with glut on Linux
=====================================================================
...
*
* \file            lesson08.c
* \author          Jeff Molofee ( NeHe ) originely, ported to Solaris/GLUT by Lakmal Gunasekara, and after by Thierry Dechaize on Linux Mint
* \version         2.0.1.0
* \date            25 mars 2023
...
*/
    ...
    window = glutCreateWindow("Jeff Molofee's GL Tutorial : draw cube with textured faces (issued BMP) - NeHe '99");
...
/**	            This Code rely internal function specialKeyPressed at the glut initialiation call glutSpecialFunc
*
